...
NUTRIENT_ALIASES = {
    "energy_kcal": [
        ...
        "energy kcal", "energy(kcal)", "cal", "ऊर्जा", "ஆற்றல்",
    ],
    "protein_g": [
        "protein", "protein (g)", "total protein", "crude protein",
        "orotein", "प्रोटीन", "புரதம்",
    ],
    "carbohydrates_g": [
    ...
    "sugar_g": [
        "sugars", "sugar", "total sugars", "total sugar", "of which sugars",
        "-total sugars", "- total sugars", "total sugars^", "cotal sugars",
        "cotal sugars (g)", "चीनी", "शर्करा", "कुल शर्करा", "சர்க்கரை", "மொத்த சர்க்கரை",
    ],
    "added_sugar_g": [
        "added sugars", "added sugar", "-added sugars", "- added sugars",
        "added sugars^", "अतिरिक्त शर्करा", "जोड़ी गई चीनी", "சேர்க்கப்பட்ட சர்க்கரை",
    ],
    "dietary_fiber_g": [
        "dietary fibre", "dietary fiber", "fibre", "fiber", "dietary fibre (g)",
        "total fibre", "- dietary fibre", "- dietary fiber", "आहार रेशा", "फाइबर",
        "நார்ச்சத்து", "உணவுநார்",
    ],
    "total_fat_g": [
        "fat", "total fat", "total fat (g)", "fat (g)", "otal fat",
        "वसा", "कुल वसा", "மொத்த கொழுப்பு",
    ],
    "saturated_fat_g": [
        "saturated fat", "saturated", "sat fat", "-saturated fat", "- saturated fat",
        "saturated fat (g)", "saturated fatty acid", "saturated fatty acids",
        "saturated fatty", "- saturated", "संतृप्त वसा", "செறிவூட்டப்பட்ட கொழுப்பு",
    ],
    "trans_fat_g": [
        "trans fat", "trans fats", "trans fatty acid", "trans fat (g)", "- trans fat",
        "-trans fat", "trans fatty acids", "- trans", "ट्रांस वसा", "டிரான்ஸ் கொழுப்பு",
    ],
